...
#define lrc_con1_init                                     \
    /*                               */     (0 << 7) |\
    /*RC32K_LDO_S1_33v               */     (1 << 6) |\
    /*RC32K_LDO_S0_33v               */     (0 << 5) |\
...
#define lrc_pll_con1                                          \
    ...
    /*SYSPLL_DS(11-0)           12 bit*/    ( ((480000000/(8*35000))-2 ) << 0  )

#define lrc_pll_con                                           \
    /*SYSPLL_LPFR2S(1-0)        3 bit*/     (  0b111 << 27 ) |\
    /*SYSPLL_ICPS(1-0)          3 bit*/     (  0b000 << 24 ) |\
