...
static void set_led_setting(u8 *led_setting_info)
{
    ...
    _s_info.led_status[2 * 3 + 1] = led_setting_info[3];
    _s_info.led_status[2 * 4 + 1] = led_setting_info[4];
    _s_info.led_status[2 * 5 + 1] = led_setting_info[5];
    _s_info.led_status[2 * 6 + 1] = led_setting_info[6];
}
...
static void get_led_setting(u8 *led_setting_info)
{
    ...
    led_setting_info[3] = _s_info.led_status[2 * 3 + 1];
    led_setting_info[4] = _s_info.led_status[2 * 4 + 1];
    led_setting_info[5] = _s_info.led_status[2 * 5 + 1];
    led_setting_info[6] = _s_info.led_status[2 * 6 + 1];
}
...
static void led_setting_sync(u8 *led_setting_info)
{
    ...
    if (get_bt_tws_connect_status()) {
        update_smartbox_setting(BIT(ATTR_TYPE_LED_SETTING));
    }
#endif
}
// 3、更新状态
