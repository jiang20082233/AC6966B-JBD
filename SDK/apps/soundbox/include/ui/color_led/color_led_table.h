...
parameter:
	...
	loop_num:循环的次数
 * */
#define COLOR_TYPE_LOOP_INIT(back_step,loop_num) {COLOR_TYPE_LOOP,0,0,0x11223344,loop_num,back_step}
/*
description:
...
parameter:
 * */
#define COLOR_END() COLOR_TYPE_COLOR_INIT(0,0,COLOR_BLACK)
