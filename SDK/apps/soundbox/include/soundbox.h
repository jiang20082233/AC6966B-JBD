...
int adv_bt_state_set_page_scan_enable();
int adv_bt_state_get_connect_mac_addr();
int adv_bt_state_cancel_page_scan();
int adv_bt_state_enter_soft_poweroff();
int adv_bt_state_tws_init(int paired);
int adv_bt_state_tws_connected(int first_pair, u8 *comm_addr);
int adv_sys_event_handler_specific(struct sys_event *event);

#define BT_STATE_INIT()                   adv_bt_state_init()
#define BT_STATE_SET_PAGE_SCAN_ENABLE()   adv_bt_state_set_page_scan_enable()
#define BT_STATE_GET_CONNECT_MAC_ADDR()   adv_bt_state_get_connect_mac_addr()
#define BT_STATE_CANCEL_PAGE_SCAN()       adv_bt_state_cancel_page_scan()
#define BT_STATE_ENTER_SOFT_POWEROFF()    adv_bt_state_enter_soft_poweroff()
#define BT_STATE_TWS_INIT(a)              adv_bt_state_tws_init(a)
#define BT_STATE_TWS_CONNECTED(a, b)      adv_bt_state_tws_connected(a,b)
