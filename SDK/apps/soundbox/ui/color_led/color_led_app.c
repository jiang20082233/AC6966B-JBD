...
#define TWINKLE_MUSIC_TIME		1000
#endif
...
static void color_led_colorful_twinkle_deal(u8 fre_mode)
{
    switch (fre_mode) {
    case TWINKLE_SLOW:
        COLOR_LED_SET(color_table_colorful_twinkle_slow, led_select);
        log_info("colorful twinkle scale slow \n");
        break;
    case TWINKLE_MID:
        COLOR_LED_SET(color_table_colorful_twinkle_mid, led_select);
        log_info("colorful twinkle scale middle \n");
        break;
    case TWINKLE_FAST:
        COLOR_LED_SET(color_table_colorful_twinkle_fast, led_select);
