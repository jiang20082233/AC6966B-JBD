...
#ifdef CONFIG_BOARD_AC696X_SMARTBOX
/***********************************************************
 *				bt 模式的 adkey table
 ***********************************************************/
#if TCFG_APP_BT_EN
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
#if (SMART_BOX_EN)
        KEY_MUSIC_PREV,	KEY_VOL_DOWN,		KEY_VOL_DOWN,		KEY_NULL,		KEY_MINOR_OPT,			KEY_NULL
#else
...
const u16 fm_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
#if (SMART_BOX_EN)
        KEY_FM_PREV_STATION, KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,		KEY_MINOR_OPT,				KEY_NULL
#else
...
const u16 linein_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
#if (SMART_BOX_EN)
        KEY_NULL,			KEY_VOL_DOWN,	KEY_VOL_DOWN,	KEY_NULL,		KEY_MINOR_OPT,				KEY_NULL
#else
...
const u16 record_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
#if (SMART_BOX_EN)
        KEY_NULL,			KEY_NULL,		KEY_NULL,		KEY_NULL,		KEY_MINOR_OPT,			KEY_NULL
#else
...
const u16 rtc_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [4] = {
#if (SMART_BOX_EN)
        KEY_RTC_DOWN,		KEY_RTC_DOWN,	KEY_RTC_DOWN,	KEY_NULL,		KEY_MINOR_OPT,			KEY_NULL
#else
...
const u16 spdif_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [2] = {
        KEY_CHANGE_MODE, KEY_POWEROFF,		KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [3] = {
        KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL,		KEY_NULL,				KEY_NULL
    },
