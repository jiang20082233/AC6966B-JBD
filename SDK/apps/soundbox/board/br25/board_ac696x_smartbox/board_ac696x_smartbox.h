#ifndef CONFIG_BOARD_AC696X_SMARTBOX_CFG_H
#define CONFIG_BOARD_AC696X_SMARTBOX_CFG_H
...
#endif
#endif
#define EQ_SECTION_MAX                      7//eq 段数，最大10 ,drc使能时，段数不可小于4
...
//                                 编译警告                                         //
//*********************************************************************************//
#if ((((TCFG_ONLINE_TX_PORT == IO_PORT_DP) && TCFG_ONLINE_ENABLE)) && (TCFG_PC_ENABLE || TCFG_UDISK_ENABLE))
