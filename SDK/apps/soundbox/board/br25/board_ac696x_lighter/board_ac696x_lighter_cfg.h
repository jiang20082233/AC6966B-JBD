#ifndef CONFIG_BOARD_AC696X_LIGHTER_CFG_H
#define CONFIG_BOARD_AC696X_LIGHTER_CFG_H
...
#define TCFG_SD0_PORTS						'F'//BR25点烟器的天线是PB3
...
#define TCFG_USB_PORT_CHARGE            DISABLE_THIS_MOUDLE
...
#define TCFG_ADKEY_PORT                     IO_PORTA_04        //AD按键端口(需要注意选择的IO口是否支持AD功能)
#define TCFG_ADKEY_AD_CHANNEL               AD_CH_PA4
...
#define LINEIN_INPUT_WAY            LINEIN_INPUT_WAY_ADC
...
#endif
#endif
#define EQ_SECTION_MAX                            10//eq 段数，最大10 , drc使能时，段数不可小于4
...
#define TCFG_LINEIN_LR_CH					AUDIO_LIN0L_CH      //BR25只有一路ADC
...
#define TCFG_LINEIN_INPUT_WAY               LINEIN_INPUT_WAY_ANALOG//LINEIN_INPUT_WAY_ANALOG
...
#endif //CONFIG_BOARD_AC696X_LIGHTER
#endif //CONFIG_BOARD_AC696X_LIGHTER_CFG_H
