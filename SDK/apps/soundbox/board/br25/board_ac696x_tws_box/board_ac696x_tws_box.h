#ifndef CONFIG_BOARD_AC696X_TWS_BOX_CFG_H
#define CONFIG_BOARD_AC696X_TWS_BOX_CFG_H

#ifdef CONFIG_BOARD_AC696X_TWS_BOX
...
#define TCFG_BLUETOOTH_BACK_MODE			1	//后台模式,不支持FM
