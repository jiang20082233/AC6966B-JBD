#ifndef _CONFIG_BOARD_AC6966B_CFG_H_
...
//                                 USB 配置                                        //
//*********************************************************************************//
#define TCFG_PC_ENABLE						0//TCFG_APP_PC_EN//PC模块使能
...
#define R_UP    91                 //9.1K，外部上拉阻值在此自行设置
#else
...
#define TCFG_PWMLED_ENABLE					0//1               			//是否支持PMW LED推灯模块
#define TCFG_PWMLED_IOMODE					LED_ONE_IO_MODE				//LED模式，单IO还是两个IO推灯
...
#define TCFG_LOUDSPEAKER_ENABLE            DISABLE
...
#define TCFG_LINEIN_LR_CH					AUDIO_LIN_DACL_CH
#define TCFG_LINEIN_CHECK_PORT				NO_CONFIG_PORT//IO_PORTC_04			// linein检测IO 
...
#if(TCFG_MIC_EFFECT_ENABLE)
#define TCFG_LINEIN_INPUT_WAY               LINEIN_INPUT_WAY_DAC//LINEIN_INPUT_WAY_ANALOG
#else
#define TCFG_LINEIN_INPUT_WAY               LINEIN_INPUT_WAY_DAC//LINEIN_INPUT_WAY_ANALOG//LINEIN_INPUT_WAY_ANALOG
#endif
...
//                                 编译警告                                         //
//*********************************************************************************//
#if ((TRANS_DATA_EN || ((TCFG_ONLINE_TX_PORT == IO_PORT_DP) && TCFG_ONLINE_ENABLE)) && (TCFG_PC_ENABLE || TCFG_UDISK_ENABLE || TCFG_SD0_PORTS == 'E'))
