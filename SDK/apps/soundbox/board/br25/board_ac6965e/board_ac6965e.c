...
const struct iokey_port iokey_list[] = {
    {
        .connect_way = TCFG_IOKEY_PP_CONNECT_WAY,          //IO按键的连接方式
        .key_type.one_io.port = TCFG_IOKEY_PP_ONE_PORT,    //IO按键对应的引脚
        .key_value = 0,                                       //按键值
    },
    ...
    },
    {
        ...
        .key_type.one_io.port = TCFG_IOKEY_MODE_ONE_PORT,
        .key_value = 3,
    },
};
...
struct port_wakeup port0 = {
    ...
    .iomap      = IO_PORTB_01,//NO_CONFIG_PORT                             //唤醒口选择
};
